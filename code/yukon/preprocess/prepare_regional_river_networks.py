from pyearth.toolbox.analysis.extract.clip_vector_by_polygon import clip_vector_by_shapefile
...
def prepare_regional_river_networks(sFilename_river_networks_in, 
    ...
    clip_vector_by_shapefile(sFilename_river_networks_in, sFilename_watershed_boundary_in, sFilename_temp)
