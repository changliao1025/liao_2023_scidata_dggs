...
sPath = '/qfs/people/liao313/workspace/python/liao_2023_scidata_dggs/'
sys.path.append(sPath)
#import two functions 

from codes.shared.prepare_regional_river_networks import prepare_regional_river_networks
#from ...shared.prepare_regional_dem import prepare_regional_dem
...
sFilename_wbd_boundary = '/qfs/people/liao313/data/hexwatershed/amazon/vector/hydrology/amazon_boundary.geojson'

#sFilename_dem_amazon = '/qfs/people/liao313/data/hexwatershed/amazon/raster/dem/hyd_ar_dem_30s/hyd_ar_dem_30s.tif'
