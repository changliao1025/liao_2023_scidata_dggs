...
sFilename_png = 'flowline_filter.png'
...
fig.suptitle("Simplified flowline by REACH", fontsize=16)
sFilename_out = '/qfs/people/liao313/workspace/python/liao_2023_scidata_dggs/figures/amazon/flowline_filter_comparison.png'
#plt.show()
