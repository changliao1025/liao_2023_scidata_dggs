...
fig.suptitle("Surface slope", fontsize=16)
# Adjust layout
...
sFilename_out = '/qfs/people/liao313/workspace/python/liao_2023_scidata_dggs/figures/amazon/surface_slope_comparison.png'
#plt.show()
