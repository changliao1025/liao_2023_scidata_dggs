...
sFilename_png = 'flow_direction_w_observation.png'
...
sFilename_out = '/qfs/people/liao313/workspace/python/liao_2023_scidata_dggs/figures/yukon/flow_direction_comparison.png'
#plt.show()
